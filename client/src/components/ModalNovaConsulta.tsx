...
export default function ModalNovaConsulta({
  ...
  const [isUtenteDialogOpen, setIsUtenteDialogOpen] = useState(false);
  ...
  return (
    <>
            ...
            <div>
              <div className="flex items-center justify-between mb-2">
                ...
                <Button
                  ...
                  variant="outline"
                  size="sm"
                  onClick={() => setIsUtenteDialogOpen(true)}
      ...
      <UtenteDialog
        open={isUtenteDialogOpen}
        onOpenChange={setIsUtenteDialogOpen}
        mode="create"
      />
    </>
  );
