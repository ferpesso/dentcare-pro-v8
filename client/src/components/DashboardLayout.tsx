...
const menuGroups: MenuGroup[] = [
  {
    ...
    items: [
      ...
      { icon: Users, label: "Utentes", path: "/utentes" },
    ]
  },
  {
    title: "Clínico",
    items: [
      ...
      { icon: Activity, label: "Tratamentos", path: "/tratamentos" },
      { icon: Activity, label: "Periodontograma", path: "/periodontograma" },
      { icon: ClipboardList, label: "Prescrições", path: "/prescricoes" },
      { icon: ShieldCheck, label: "PEM (Receitas)", path: "/pem" },
      { icon: Brain, label: "Análise IA", path: "/analise-ia" },
    ]
  },
  {
    title: "Gestão",
    items: [
      { icon: DollarSign, label: "Faturação", path: "/faturacao" },
      { icon: FileText, label: "Orçamentos", path: "/orcamentos" },
      { icon: Package, label: "Stocks", path: "/stocks" },
      { icon: MessageSquare, label: "WhatsApp", path: "/lembretes" },
  ...
  },
  {
    title: "Sistema",
    items: [
      { icon: Shield, label: "Segurança / RGPD", path: "/seguranca" },
